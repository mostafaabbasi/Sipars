...
{
    public class ApplicationRoleManagerRepository : RoleManager<CustomRole, int>, IApplicationRoleManager
    {
        private readonly IUnitOfWork _uow;
        private readonly IRoleStore<CustomRole, int> _roleStore;
        private readonly IDbSet<ApplicationUser> _users;
        public ApplicationRoleManagerRepository(IUnitOfWork uow, IRoleStore<CustomRole, int> roleStore)
            : base(roleStore)
        {
            _uow = uow;
