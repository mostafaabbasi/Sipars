...
namespace PrivateTraining.ServiceLayer.Interface
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        /// <param name="user"/>
        /// <returns/>
        Task<bool> CheckPersonnelId(int PersonnelId);
        Task<bool> CheckMobileNumber(string Mobile);
        Task<bool> CheckNationalCode(string NationalCode, int Id);
        Task<bool> CheckEmails(string Email, int Id);
        Task<bool> CheckUserNames(string UserName, int Id);
        Task<bool> CheckUserNameAndEmails(string UserName, int Id);

        Task<IdentityResult> InactiveUser(int UserId);
        bool ActiveUser(string ActiveCode);
        Task<IdentityResult> DeleteUser(int UserId);

        //Task<IdentityResult> SuspensionUser(int UserId);

        Task<int> GetUserIdWithersonnelId(int PersonnelId);

        //  Task<bool> checkSuspensionUser(int UserId);

        Task<ApplicationUser> FindByUserNameAndEmail(string UserName, string Email);
        Task<ApplicationUser> FindByUserNameAndMobile(string UserName, string Mobile);
        Task<ApplicationUser> FindByEmailAndNationalCode(string Email, string NationalCode);
        ...
        Task<IQueryable<ApplicationUser>> GetAllModarators();
        Task<IQueryable<ApplicationUser>> GetAlTypelUsers();
        IQueryable<ApplicationUser> GetSelectedUsers(string[] UserId);
        int GetCurrentUserId();
        Task<IQueryable<ApplicationUser>> GetAllAdmins();
        IQueryable<ApplicationUser> GetAllAdmin();
        int GetCountAdmins();
        IQueryable<ApplicationUser> GetAllUsersWithId(int UserId);
        Task<IQueryable<ApplicationUser>> GetAlTypelUsersWithOutAdmin();
        IQueryable<ApplicationUser> GetAlTypelUsersWithOutAdmins();
        int GetCountUserNewRegister();
