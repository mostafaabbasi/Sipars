...
namespace PrivateTraining.Areas.Panel.Controllers
{
    public partial class ServiceController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ServiceController Actions { get { return MVC.Panel.Service; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Panel";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string List = "~/Areas/Panel/Views/Service/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ServiceController : PrivateTraining.Areas.Panel.Controllers.ServiceController
    {
