class Utils {
    ...
    static TableToExcel = (table, name) => {
        let uri = 'data:application/vnd.ms-excel;base64,',
            template = '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>{worksheet}</x:Name><x:WorksheetOptions><x:DisplayGridlines/><x:DisplayRightToLeft/> </x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--><meta http-equiv="content-type" content="text/plain; charset=UTF-8"/></head><body><table>{table}</table></body></html>'
            , base64 = function (s) {
    ...
    static isNationalCode = (code) => {
        ...
        if (mod < 2 && code[length - index] == mod)
            return true
    ...
    static currencyFormat(currency) {
        if (currency === undefined || isNaN(currency)) {
            ...
            let a = 1000,
                b = 10,
                c = ['تومان', 'هزار تومان', 'میلیون تومان', 'میلیارد تومان', 'تیلیارد تومان'],
    ...
    static getDateLocalFormat(date) {
        if (!date) {
            return ''
        }
...
// pSBC ( -0.4, color5 ); // #F3A + [40% Darker] => #c62884
    ...
    static arrayEqual(a1, a2) {
        return a1.length === a2.length &&
            a1.every(i => a2.includes(i))
    }

    static toFlattenArray(object) {
        return [].concat.apply([], [object])
    ...
    static getErrorList(errorList, fieldInfo) {
        return errorList.map(error => Utils.getErrorText(error, fieldInfo)).join(' , ')
    }
