...
namespace PrivateTraining.DataLayer.Context
{
    public class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            #region PrivateTraining 10001 , 10003,  10004 , 10005 , 10007

            #region Services 10001
            ...
            context.SaveChanges();
            int AccessIds = context.Actions.FirstOrDefault(c => c.AccessCode == "10001").Id;
            ...
            context.SaveChanges();
            AccessIds = context.Actions.FirstOrDefault(c => c.AccessCode == "10003").Id;
            ...
            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = " خدمات قطعی شده  خدمت دهنده",
            ...
            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = " خدمات تمام شده  خدمت دهنده",
            ...
            #region Climing 10009  ,20001  ,20002
            ...
            context.SaveChanges();
            int SaveInfoId = context.Actions.FirstOrDefault(c => c.AccessCode == "10009").Id;

            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = " ثبت لوازم مصرفی",
                Actionname = "Equipment",
                Controller = "Equipment",
                Area = "ClimingArea",
                ParentId = SaveInfoId,
                IsEnable = true,
                ShowName = "ثبت لوازم مصرفی",
                AccessCode = "10009001"
            });
            context.SaveChanges();
            ...
            {
                Name = " ثبت نام برنامه",
                Actionname = "ProgramRegister",
                Controller = "Program",
                Area = "ClimingArea",
                ParentId = SaveInfoId,
                IsEnable = true,
                ShowName = "ثبت نام برنامه",
                AccessCode = "10009004"
            });
            context.SaveChanges();
            ...
            context.SaveChanges();
            int ReportId = context.Actions.FirstOrDefault(c => c.AccessCode == "20001").Id;

            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = " لیست باشگاه ها",
                Actionname = "ListClubs",
                Controller = "Club",
                Area = "ClimingArea",
                ParentId = ReportId,
                IsEnable = true,
                ShowName = "لیست باشگاه ها",
                AccessCode = "20001001"
            });
            context.SaveChanges();
            ...
            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = "نمایش لیست باشگاه ها برای مدیران",
                Actionname = "ListClubForModrator",
                Controller = "Club",
                Area = "ClimingArea",
                ParentId = ReportId,
                IsEnable = true,
                ShowName = "نمایش لیست باشگاه ها برای مدیران",
                AccessCode = "20001002"
            });
            context.SaveChanges();
            ...
            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = "نمایش لیست برنامه ها",
                Actionname = "ListProgram?Type=Ad",
                Controller = "Program",
                Area = "ClimingArea",
                ParentId = ReportId,
                IsEnable = true,
                ShowName = "نمایش لیست برنامه ها",
                AccessCode = "20001003"
            });
            context.SaveChanges();
            ...
            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = "نمایش لیست برنامه ها برای مدیران",
                Actionname = "ListProgram?Type=Mo",
                Controller = "Program",
                Area = "ClimingArea",
                ParentId = ReportId,
                IsEnable = true,
                ShowName = "نمایش لیست برنامه ها برای مدیران",
                AccessCode = "20001004"
            });
            context.SaveChanges();
            ...
            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                ...
                Actionname = "ShowRegisters",
                Controller = "Program",
                Area = "ClimingArea",
                ParentId = ReportId,
                IsEnable = true,
                ShowName = " لیست ثبت نام ها",
                AccessCode = "20001005"
            });
            context.SaveChanges();
            ...
            {
                Name = " لیست تراکنش ها ",
                Actionname = "ShowTransactions",
                Controller = "Program",
                Area = "ClimingArea",
                ParentId = ReportId,
                IsEnable = true,
                ShowName = " لیست تراکنش ها",
                AccessCode = "20001006"
            });
            context.SaveChanges();
            ...
            {
                Name = " لیست نظرات ",
                Actionname = "ListCommentForAdmin",
                Controller = "Comment",
                Area = "ClimingArea",
                ParentId = ReportId,
                IsEnable = true,
            ...
            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = " لیست عکس های ارسالی کاربران ",
                Actionname = "ListProgramPicByUser",
                Controller = "Comment",
                Area = "ClimingArea",
                ParentId = ReportId,
                IsEnable = true,
                ShowName = " لیست عکس های ارسالی کاربران",
                AccessCode = "20001008"
            });
            context.SaveChanges();
            #endregion

            #region Charging panel 20002

            context.Actions.AddOrUpdate(p => p.AccessCode, new PrivateTraining.DomainClasses.Entities.FrameWork.Action
            {
                Name = "شارژ پنل",
                Actionname = "ChargingPanel",
                Controller = "Payment",
                Area = "Framework",
                ParentId = 0,
                IsEnable = true,
            ...
            context.SaveChanges();
            // int SaveInfoId = context.Actions.FirstOrDefault(c => c.AccessCode == "20002").Id;

            #endregion Charging panel
            ...
            //{
            //    Name = "مدیریت خدمات",
            //    ActionId = context.Actions.Where(c => c.AccessCode == "10001001").FirstOrDefault().Id,
            //    IsEnable = true,
            //    ParentId = MainData,
            //    Code = "10001001",
            //    RoleAccess = "Admin,Administrator,Modrator"
            ...
            //});
            //context.SaveChanges();
            //int OtherData = context.Menus.FirstOrDefault(c => c.Code == "5003").Id;

            //context.Menus.AddOrUpdate(p => p.Name, new PrivateTraining.DomainClasses.Entities.FrameWork.Menu
            //{
            //    Name = "  ثبت نام خدمت دهنده",
            //    ActionId = context.Actions.Where(c => c.AccessCode == "10002003").FirstOrDefault().Id,
            //    IsEnable = true,
            //    ParentId = OtherData,
            //    Code = "10002003",
            //    RoleAccess = "Admin,Administrator,Modrator,User"
            ...
            context.SaveChanges();
            int Data = context.Menus.FirstOrDefault(c => c.Code == "10009").Id;

            //context.Menus.AddOrUpdate(p => p.Name, new PrivateTraining.DomainClasses.Entities.FrameWork.Menu
            //{
            //    Name = "لوازم  مصرفی",
            //    ActionId = context.Actions.Where(c => c.AccessCode == "10009001").FirstOrDefault().Id,
            //    IsEnable = true,
            //    ParentId = Data,
            //    Code = "10009001",
            //    RoleAccess = "Admin,Administrator,Modrator"
            ...
            {
                Name = "باشگاه",
                ActionId = context.Actions.Where(c => c.AccessCode == "10009002").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "10009002",
                RoleAccess = "Admin,Administrator"
            ...
            {
                Name = "برنامه",
                ActionId = context.Actions.Where(c => c.AccessCode == "10009003").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "10009003",
                RoleAccess = "Admin,Administrator,Modrator"
            ...
            context.SaveChanges();
            Data = context.Menus.FirstOrDefault(c => c.Code == "20001").Id;

            context.Menus.AddOrUpdate(p => p.Name, new PrivateTraining.DomainClasses.Entities.FrameWork.Menu
            {
                Name = "لیست باشگاه ها",
                ActionId = context.Actions.Where(c => c.AccessCode == "20001001").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "20001001",
                RoleAccess = "Admin,Administrator"
            ...
            context.Menus.AddOrUpdate(p => p.Name, new PrivateTraining.DomainClasses.Entities.FrameWork.Menu
            {
                Name = "نمایش باشگاه ها",
                ActionId = context.Actions.Where(c => c.AccessCode == "20001002").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "20001002",
                RoleAccess = "Modrator"
            ...
            {
                Name = "لیست برنامه ها",
                ActionId = context.Actions.Where(c => c.AccessCode == "20001003").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "20001003",
                RoleAccess = "Admin,Administrator"
            ...
            context.Menus.AddOrUpdate(p => p.Name, new PrivateTraining.DomainClasses.Entities.FrameWork.Menu
            {
                Name = "نمایش برنامه ها",
                ActionId = context.Actions.Where(c => c.AccessCode == "20001004").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "20001004",
                RoleAccess = "Modrator"
            ...
            {
                Name = "لیست ثبت نام ها",
                ActionId = context.Actions.Where(c => c.AccessCode == "20001005").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "20001005",
                RoleAccess = "Admin,Administrator,Modrator,User"
            ...
            {
                Name = "لیست تراکنش ها",
                ActionId = context.Actions.Where(c => c.AccessCode == "20001006").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "20001006",
                RoleAccess = "Admin,Administrator,Modrator,User"
            ...
            {
                Name = "لیست نظرات ",
                ActionId = context.Actions.Where(c => c.AccessCode == "20001007").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "20001007",
                RoleAccess = "Admin,Administrator,Modrator"
            ...
            {
                Name = "لیست عکس های ارسالی کاربران ",
                ActionId = context.Actions.Where(c => c.AccessCode == "20001008").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = Data,
                Code = "20001008",
                RoleAccess = "Admin,Administrator,Modrator"
            ...
            {
                Name = "شارژ پنل",
                ActionId = context.Actions.Where(c => c.AccessCode == "20002").FirstOrDefault().Id,
                IsEnable = true,
                ParentId = 0,
                Code = "20002",
                RoleAccess = "Admin,Administrator,Modrator,User",
            ...
            context.SaveChanges();
            //  Data = context.Menus.FirstOrDefault(c => c.Code == "20002").Id;
